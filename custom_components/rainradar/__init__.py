...
async def async_setup(hass: HomeAssistant, config: dict):
    ...
    # Load crop box, image limit, and pause duration configuration
    ...
    pause_seconds = config.get(DOMAIN, {}).get("pause_seconds", 3)  # Default to 3 seconds
    hass.data[DOMAIN] = {"crop_box": crop_box, "image_limit": image_limit, "pause_seconds": pause_seconds}
